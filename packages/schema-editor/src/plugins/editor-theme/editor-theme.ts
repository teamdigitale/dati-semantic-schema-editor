export function applyTheme() {
  // @ts-expect-error ace is not defined
  ace.define(
    ...
    .ace-tomorrow-night-blue .ace_gutter .ace_gutter-cell.ace_error {\
    background: #DB0026\
    }\
    .ace-tomorrow-night-blue .ace_gutter .ace_gutter-cell.ace_warning {\
    background: #FFB600\
    }\
