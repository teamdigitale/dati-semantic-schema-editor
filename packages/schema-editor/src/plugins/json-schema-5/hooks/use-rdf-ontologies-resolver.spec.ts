...
describe('useRDFPropertyResolver', () => {
    ...
    it('should resolve RDF property with domain, range and comment', async () => {
        ...
        const { result } = renderHook(() =>
            useRDFPropertyResolver('https://w3id.org/italia/onto/CPV/givenName'),
        );
    ...
    it('should resolve controlled vocabulary when available', async () => {
        ...
        const { result } = renderHook(() =>
            useRDFPropertyResolver('https://w3id.org/italia/onto/CPV/hasEducationLevel'),
        );
...
describe('useRDFClassTreeResolver', () => {
    ...
    it('should resolve class hierarchy excluding blank nodes', async () => {
        const mockResponse = {
            results: {
                bindings: [
                    { "parent": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Entity" }, "child": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Agent" } },
                    { "parent": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Object" }, "child": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Agent" } },
                    { "parent": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Entity" }, "child": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Object" } },
                    { "parent": { "type": "uri", "value": "https://w3id.org/italia/onto/CPV/Person" }, "child": { "type": "uri", "value": "https://w3id.org/italia/onto/CPV/Alive" } },
                    { "parent": { "type": "uri", "value": "https://w3id.org/italia/onto/l0/Agent" }, "child": { "type": "uri", "value": "https://w3id.org/italia/onto/CPV/Person" } }],
            },
        };
...
describe('useRDFClassResolver', () => {
    ...
    it('should resolve class with label, comment and superclasses', async () => {
        ...
        expect(result.current.data).toEqual({
            ...
            ontologicalClassSuperClasses: [
                'https://w3id.org/italia/onto/CPV/Agent',
...
describe('useRDFClassPropertiesResolver', () => {
    ...
    it('should resolve all properties for a class including inherited ones', async () => {
        ...
        const { result } = renderHook(() =>
            useRDFClassPropertiesResolver('https://w3id.org/italia/onto/CPV/Person'),
        );
        ...
        expect(result.current.data?.classProperties?.[0].fieldUri).toBe(
